...
class StartServer extends Job
{
    public function getJobName()
    {
        return t('Start Server');
    }

    public function getJobDescription()
    {
        return t('Starts the live chat server.');
    }
    ...
    public function run()
    {
        ...
        if ($permissionKey instanceof Key && $permissionKey->validate()) {
            ...
            try {
                $response = $client
                    ->setUri((string)Url::to("/simple_live_chat/api/start_server")->setQuery([
            ...
            return t("The server has been started successfully.");
        } else {
